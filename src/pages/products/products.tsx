    ...
    <react.Fragment>
      ...
      <div className={"content-block dx-card responsive-paddings"}>
        ...
        >
          ...
          <Column dataField={"barcode"} caption={t("column.barcode")}>
            <RequiredRule />
          </Column>
          <Column
            dataField={"shortCode"}
            caption={t("column.shortcode")}
          ></Column>
          <Column dataField={"gender"} caption={t("column.gender")}>
            <Lookup dataSource={gender} valueExpr="id" displayExpr="name" />
          </Column>
          <Column dataField={"price"} caption={t("column.price")}>
            <RequiredRule />
            <Format type="currency" precision={2} />
          </Column>
          <Column
            dataField={"size"}
            caption={t("column.size")}
            dataType="number"
          ></Column>
          <Column
            dataField={"quantity"}
            caption={t("column.quantity")}
            dataType="number"
          >
            <RequiredRule />
          </Column>
          ...
          <Column
            ...
            caption={t("column.pictureUrl")}
          ></Column>
          <Column dataField={"unitId"} caption={t("column.unit")}>
            <RequiredRule />
            <Lookup dataSource={units} valueExpr="id" displayExpr="name" />
          </Column>
          <Column dataField={"categoryId"} caption={t("column.category")}>
            <RequiredRule />
