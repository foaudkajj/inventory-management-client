...
export default (props: any) => {
  ...
  const status = Object.values(UserStatus).map((v) => {
    return {
      id: v,
      name: v.toLowerCase(),
    };
    ...
    <React.Fragment>
      ...
      <div className={"content-block dx-card responsive-paddings"}>
        ...
        >
          ...
          ></Column>
          <Column dataField={"firstName"} caption={t("column.first_name")}>
            <RequiredRule />
          </Column>
          <Column dataField={"lastName"} caption={t("column.last_name")}>
            <RequiredRule />
          </Column>
          <Column dataField={"username"} caption={t("column.user_name")}>
            <RequiredRule />
          </Column>
          <Column
            dataField={"password"}
            caption={t("column.password")}
          ></Column>
          <Column dataField={"email"} caption={t("column.email")}></Column>
          <Column dataField={"gsm"} caption={t("column.gsm")}></Column>
          <Column dataField="roleId" caption={t("column.role")}>
            <Lookup dataSource={roles} valueExpr="id" displayExpr="name" />
          </Column>
          <Column dataField="branchId" caption={t("column.branch")}>
            <Lookup dataSource={branches} valueExpr="id" displayExpr="name" />
          </Column>
          <Column dataField="status" caption={t("column.user_status")}>
